...
class test_inherit_basemodel(unittest.TestCase):
    """it tests if user inherit from BaseModel"""
...
class test_Amenity_BaseModel(unittest.TestCase):
    ...
    def test_save_method(self, mock_storage):
        """ save method testing and if it update"""
        instance5 = Amenity()
...
class TestAmenity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Tests that Amenity has attribute name, and is an empty string"""
        amenity = Amenity()
    ...
    def test_to_dict_creates_dict(self):
        """test to_dict creates a dict with proper attributess"""
        am = Amenity()
        print(am.__dict__)
        new_d = am.to_dict()
    ...
    def test_to_dict_values(self):
        """test that values in dict returned from to_dict are right"""
    ...
    def test_str(self):
        """test that the str method has the right output"""
        amenity = Amenity()
